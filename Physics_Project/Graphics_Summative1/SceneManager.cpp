...
void CSceneManager::MouseInput(int _button, int _button_state)
{
	Game->MouseInput(_button, _button_state);
}

void CSceneManager::MousePosition(int _x, int _y)
{
	Game->MousePosition(_x, _y);
}
